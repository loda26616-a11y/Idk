...
BROADCAST_IMAGE_URL = "https://kommodo.ai/i/BZJOSOTFvIlJnDQDropG"
    ...
    for attempt in range(3):
        try:
            ...
            await context.bot.send_photo(
                ...
                caption="🚀🔥 𝗪𝗘𝗟𝗖𝗢𝗠𝗘 𝗧𝗢 RD 𝗧𝗥𝗔𝗗𝗘𝗥𝗦 𝗣𝗥𝗘𝗠𝗜𝗨𝗠 𝗕𝗢𝗧 🔥",
                reply_markup=welcome_button
            )

            if APK_CACHE:
                apk_button = InlineKeyboardMarkup([
                    [InlineKeyboardButton("💀 𝙎𝙀𝘾𝙍𝙀𝙏 𝘼𝙋𝙆 𝙁𝙄𝙇𝙀🔥", url=f"https://t.me/{BOT_USERNAME}?start=apk")]
                ])
